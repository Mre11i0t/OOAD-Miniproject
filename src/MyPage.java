...
public class MyPage extends JFrame {
	...
	public MyPage() throws Exception {
		...
		label.setIcon(new ImageIcon(MyPage.class.getResource("/images/Untitled-4.jpeg")));
		label.setBounds(0, 11, 229, 69);
		contentPane.add(label);
		
		JLabel lblDate = new JLabel("Date");
		lblDate.setHorizontalAlignment(SwingConstants.CENTER);
		lblDate.setFont(new Font("Calibri Light", Font.PLAIN, 15));
		lblDate.setBounds(585, 23, 57, 31);
		contentPane.add(lblDate);
		
		textField_1 = new JTextField();
		textField_1.setFont(new Font("Calibri Light", Font.PLAIN, 15));
		...
		lblGender.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblGender.setBounds(28, 190, 99, 24);
		panel.add(lblGender);
		
		JLabel lblAddress = new JLabel("Address");
		lblAddress.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblAddress.setBounds(28, 237, 99, 24);
		panel.add(lblAddress);
		
		JLabel lblAccountNo = new JLabel("Account No.");
		lblAccountNo.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblAccountNo.setBounds(356, 54, 80, 24);
		panel.add(lblAccountNo);
		
		JLabel lblAccountType = new JLabel("Account Type");
		lblAccountType.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblAccountType.setBounds(356, 100, 92, 24);
		panel.add(lblAccountType);
		
		JLabel lblCaste = new JLabel("Gender");
		lblCaste.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblCaste.setBounds(356, 145, 80, 24);
		panel.add(lblCaste);
		
		JLabel lblMobile = new JLabel("Mobile");
		lblMobile.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					String sql = "update Account set Address ='"+value1+"',Mobile ='"+value2+"' where Name='"+value6+"'";
		...
		panel.add(lblUser);
		lblUser.setFont(new Font("Calibri Light", Font.PLAIN, 13));
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String sql = "Select Name,DOB,Pin,Address,Acc,Acc_Type,Gender,Mobile from Account where Name=?";
				try {
					pst = conn.prepareStatement(sql);
		...
		lblName_1.setFont(new Font("Calibri Light", Font.PLAIN, 15));
		panel_1.add(lblName_1);
		
		JLabel lblAccountNo_1 = new JLabel("Account No. ");
		lblAccountNo_1.setBounds(156, 143, 131, 22);
		lblAccountNo_1.setFont(new Font("Calibri Light", Font.PLAIN, 15));
		...
		lblAvailableBalance.setFont(new Font("Calibri Light", Font.PLAIN, 15));
		...
		lblDepositAmount.setFont(new Font("Calibri Light", Font.PLAIN, 15));
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String sql = "Select Name,Acc,Balance from Balances where Name=?";
				try {
					pst = conn.prepareStatement(sql);
		...
		btnDeposit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					// Update transactions table fromaccount, toaccount, amount, date
					String sql2 = "insert into Transactions (From_Acc,To_Acc,Amount,Date) values (?,?,?,?)";
					pst = conn.prepareStatement(sql);
					pst.execute();
					createTable();
					// Create two prepared statements to insert data into the two tables
		...
		lblName_2.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblName_2.setBounds(143, 76, 121, 22);
		panel_2.add(lblName_2);
		
		JLabel lblAccountNo_2 = new JLabel("Account No.");
		lblAccountNo_2.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		lblAvailableBalance_1.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		lblTransferAmount.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblTransferAmount.setBounds(143, 214, 132, 22);
		panel_2.add(lblTransferAmount);
		
		JLabel lblCreditAmount = new JLabel("Recipient");
		lblCreditAmount.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		btnShow.setFont(new Font("Calibri Light", Font.PLAIN, 12));
		...
		textField_28.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent arg0) {
				try {
					...
					// Update transactions table with From_Acc , To_Acc , Amount , Date with value1, 0, value2, date
					String sql2 = "insert into Transactions (From_Acc,To_Acc,Amount,Date) values (?,?,?,?)";
					pst = conn.prepareStatement(sql2);
					pst.setString(1, textField_20.getText());
					pst.setString(2, textField_28.getText());
					// Calculate transaction amount
					pst.setString(3, textField_24.getText());
					pst.setString(4, date);
					pst.execute();
		...
		lblAvailableBalance_2.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblAvailableBalance_2.setBounds(177, 169, 116, 22);
		panel_3.add(lblAvailableBalance_2);
		
		JLabel lblAmount = new JLabel("Amount ");
		lblAmount.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		lblAmount.setBounds(177, 213, 116, 22);
		panel_3.add(lblAmount);
		
		JLabel lblTotal = new JLabel("Total");
		lblTotal.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		btnWithdraw.setFont(new Font("Calibri Light", Font.PLAIN, 11));
	    ...
	    table = new JTable();
	    table.setFont(new Font("Calibri Light", Font.PLAIN, 10));
		...
		table_1 = new JTable();
		table_1.setFont(new Font("Calibri Light", Font.PLAIN, 13));
		...
		lblAvailableBalance_3.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		label_5.setFont(new Font("Calibri Light", Font.PLAIN, 12));
		...
		label_7.setFont(new Font("Calibri Light", Font.PLAIN, 12));
		...
		lblUser_2.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		btnSearch_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String sql = "Select Name,Acc from Account where Name=?";
				try {
					pst = conn.prepareStatement(sql);
		...
		lblEnterOldPin.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		lblEnterNewPin.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		// Panel_8 from Create_account page
		...
		lblAccountNo_5.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		lblName_6.setFont(new Font("Calibri Light", Font.PLAIN, 14));
		...
		lblConfirmNewPin.setFont(new Font("Calibri Light", Font.PLAIN, 14));
	...
	private void Table() {
		try {
			...
			String sql = "select Acc,Acc_Type,Name,Gender,Mobile,Address From Account";
			pst = conn.prepareStatement(sql);
			rs = pst.executeQuery();
	...
	private void Table2() {
		try {
			...
			String sql = "select From_Acc,To_Acc,Amount,Date from Transactions";
			pst = conn.prepareStatement(sql);
			rs = pst.executeQuery();
	...
	// Create transactions table if not exists with from,to and amount and date
	private void createTable() {
		String sql = "CREATE TABLE IF NOT EXISTS Transactions (From_Acc VARCHAR(20),To_Acc VARCHAR(20),Amount FLOAT,Date VARCHAR(20))";
		try {
			pst = conn.prepareStatement(sql);
			pst.execute();
		} catch (Exception e) {
